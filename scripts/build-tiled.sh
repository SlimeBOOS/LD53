...
tiled --export-tileset lua assets/fun.tsx src/resources/fun.lua

lua scripts/process-tilesets.lua src/resources/world.lua src/resources/city.lua src/resources/landscape.lua src/resources/buildings.lua src/resources/cars.lua src/resources/fun.lua
